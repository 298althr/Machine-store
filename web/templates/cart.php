<div class="breadcrumb">
  ...
  <span><?= __('shopping_cart') ?></span>
</div>

<div class="page-header">
  <h1 class="page-title"><?= __('shopping_cart') ?></h1>
  <p class="page-subtitle"><?= count($cart) ?> item<?= count($cart) !== 1 ? 's' : '' ?> in your order</p>
</div>
...
<div class="card">
  <div class="card-body text-center" style="padding: 64px;">
    ...
    <h3><?= __('cart_empty') ?></h3>
    <p style="color: #64748b;"><?= __('start_shopping') ?></p>
