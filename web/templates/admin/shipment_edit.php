    ...
    <form method="POST" action="/admin/shipments/<?= $shipment['id'] ?>/update-info">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
        <div class="form-group">
          ...
          <small style="color: #64748b; font-size: 0.875rem;">Typically 3 days from shipment creation</small>
        </div>
        
        <div class="form-group">
          <label class="form-label">Delivery Destination</label>
          <input type="text" name="destination" class="form-control" 
                 value="<?= htmlspecialchars($shipment['destination'] ?? '') ?>"
                 placeholder="e.g., Borgny Marine Terminal, Gulf of Mexico, USA">
        </div>
      </div>
